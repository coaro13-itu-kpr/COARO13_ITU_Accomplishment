...
const CATEGORIES: { [key: string]: string[] } = {
  'Technical Services': [
    ...
    'Property Appraisal',
    'Submission of AARs for Publication',
    'Submission of CARs for Publication',
    'Request for Reconsideration on Technical Review and Inspection',
  ...
  'General Administration and Support': [
    ...
    'Voice over Internet Protocol (VoIP)-PBX Installation/Configuration, Administration and Maintenance',
    'Internet configuration, connection and other technical assistance related to internet',
    'Database backup',
    'CAMS and Biometric Machine Maintenance and System Administration',
    ...
    'Technical Support for eNGAS and eBudget System',
    'Initial Setup of New Desktop/Laptop',
    'Website Content Management',
    'Walk-in Client Queries',
    'Inspection of Deliveries of Supplies and Signs IAR',
    'Inspection of all Air Conditioning Units for Repair',
    'Technical Support for PSAO Network Infrastructure Problems',
    'Attendance to BAC Meetings',
    'Attendance to Trainings/Webinars',
    'Others',
  ],
  'Other Activities Special Assignments': [
    'Resource Person/Assistant RP for eNGAS and eBudget Functional Training and Other IT Trainings',
  ],
};
